...
export const Home = () => {
  ...
  const images = [
    ...
    },
    {
      key: 'set4',
      mainT: 'Australia',
      urls: ['https://res.cloudinary.com/dw3vqhvte/image/upload/v1731620544/Travel_4_wbhatr.png'],
      smallT: 'Explore this location',
    },
    {
      key: 'set5',
      mainT: 'Canada',
      urls: ['https://res.cloudinary.com/dw3vqhvte/image/upload/v1731620541/Travel_5_xeli36.png'],
      smallT: 'Explore this location',
    },
  ];
  ...
  const teamImages = [
    {
      key: 'set1',
      mainT: 'Toba Subair',
      urls: ['https://res.cloudinary.com/dw3vqhvte/image/upload/v1732384912/1_oz3mzf.jpg'],
      smallT: 'Ceo/Founder',
    },
    {
      key: 'set2',
    ...
    <>
          ...
          <ScrollLink to="explore" className="button">
            <button className="button__con">
              ...
              <span className="icon-container">
                <FontAwesomeIcon icon={faCircleArrowRight} className="arrow-icon-font-awesome" />
              </span>
            </button>
          </ScrollLink>
        </div>
      ...
      <section className="whoweare__section" id="who">
        <div className="whoweare__con">
          <div className="whoweare" data-aos="fade-up" data-aos-duration="3000">
            <p>Who we are </p>
            <h2>
              Tripperz Way is a professional and trust worthy travel and tour company that offers outstanding, swift and
              memorable travel experience to travelers worldwide. Our vision is to become the number one choice for
              individual and cooperate clients for their travel experience by providing excellent customer service and
      ...
      <section className="comment__section">
        <div className="comment__con" data-aos="fade-up">
          ...
          <h1 className="comment__heading">The world is a book, and those who do not travel read only one page.</h1>
          <p> - Saint Augustine</p>
        </div>
      </section>
        ...
        <div className="our__service__con">
          <div className="our__service" data-aos="fade-up" data-aos-duration="1000">
            ...
            <h1 className="our__service__heading">
              Our comprehensive services are designed to cater to all your travel needs
            </h1>
          </div>
      ...
      <section className="destination__section" id="explore">
        <div className="destination__con" data-aos="fade-up" data-aos-duration="3000">
                  ...
                  >
                    <p>
                      ...
                      <span className="icon-container2">
                        <FontAwesomeIcon icon={faCircleArrowRight} className="arrow-icon-font-awesome2" />
                      </span>
                    </p>
                  </Link>
                </div>
      ...
      <section className="testimonial__section">
        <div className="testimonial__con" data-aos="fade-up">
          <h1 className="testimonial__heading">What Our Clients Say About Us</h1>
        ...
        >
          <SwiperSlide>
            <div className="testimonial__sub">
              <h2>
                I've worked with Tripperz Way multiple times and it has always been a smooth experience. My standout
                moment from my experience with Tripperz Way was when they curated a lovely tour for me and my wife for
                our honeymoon in Zanzibar, I created memories that I'll never forget.
              </h2>
          ...
          <SwiperSlide>
            <div className="testimonial__sub">
              <h2>
                Right from the start, I've been a huge fan of Tripperz Way and the swift and excellent customer service
                they offer. Most recently, I attended a world class conference in Egypt through their visa and tour
          ...
          <SwiperSlide>
            <div className="testimonial__sub">
              <h2>
                I had an amazing trip to South Africa with Tripperz Way. From exploring the stunning Safaris to enjoying
                the warm culture in Cape Town, it was definitely great vacation!
              </h2>
              <div className="testimonial__cap">
                <h3> DR. BOLU</h3>
                <img src="./assets/Stars.svg" alt="stars" />
          ...
          <SwiperSlide>
            <div className="testimonial__sub">
              <h2>
                I've always been worried about traveling internationally but my mindset has changed thanks to Tripperz
                Way! Their lovely travel representatives made sure I had a seamless trip from start to finish, I can't
          ...
          <SwiperSlide>
            <div className="testimonial__sub">
              <h2>
                I've known about Tripperz Way for a while and decided to book my last trip to Seychelles with them. What
                I really loved about my experience was the consistent communication. They stayed in touch with me
                throughout my trip and were available to resolve any issues that came up! I highly recommend them for
                anyone who's anxious or scared about traveling abroad!
              </h2>
              <div className="testimonial__cap">
                <h3> DR.BODE </h3>
                <img src="./assets/Stars.svg" alt="stars" />
          ...
          <SwiperSlide>
            <div className="testimonial__sub">
              <h2>
                All my trips with Tripperz Way have been unforgettable! With them, I've had lovely visits to Spain,
                Canada and the UK. They always take their time to plan a detailed itinerary and they also book the best
      ...
      <section className="location__section">
        <div className="location__con" data-aos="fade-up" data-aos-duration="3000">
          ...
          <div className="location__sub">
            <h2>Lagos</h2>
            <p>Kilometer 28, Lekki-Epe expressway Opposite 2nd gate Abijo GRA, Lagos.</p>
          </div>
        </div>
      </section>
      <Footer />
